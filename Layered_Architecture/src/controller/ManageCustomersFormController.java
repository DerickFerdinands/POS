...
public class ManageCustomersFormController {
    ...
    CustomerOptions CustomerBO = (CustomerOptions) BOFactory.getBOFactoryInstance().getBO(BOFactory.BOTypes.CUSTOMER);
...
;
            ...
            for (CustomerDTO customer : CustomerBO.getAllCustomers()) {
